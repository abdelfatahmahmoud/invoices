                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">عدد اجمالى الفواتير : {{ \App\invoices::count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">النسبه المئويه : 100%</span>
										</span>
                        </div>
                    </div>
                </div>
                            ...
                            <span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                @php
                                                    ...
                                                    echo 'النسبه : '. round( $count_invoices2) . '%';
                                                @endphp
                                            </span>
										</span>
                        </div>
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                @php
                                                    $count_all= \App\invoices::count();
                                                    $count_invoices2 = \App\invoices::where('value_status', 1)->count();
                                                    if($count_invoices2 == 0){
                                                    $count_invoices2 = 0;
                                                    }
                                                    else{
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                @php
                                                    $count_all= \App\invoices::count();
                                                    $count_invoices2 = \App\invoices::where('value_status', 3)->count();
                                                    if($count_invoices2 == 0){
                                                    $count_invoices2 = 0;
                                                    }
                                                    else{
